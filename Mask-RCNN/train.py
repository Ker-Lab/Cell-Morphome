...
def main():
    ...
    train_dir = "C:\\Data\\Tingwei\\Dataset-mrcnn-16bit\\train"
    #define the path to the validation directory containing instance_ids.png and raw.tif
    val_dir = "C:\\Data\\Tingwei\\Dataset-mrcnn-16bit\\val"
    #define the path to the directory that output trained weights should be saved
    out_dir = "C:\\Data\\Tingwei\\Usiigaci-master1.x\\Usiigaci-master\\Mask R-CNN\\trained_network"
    #define the path of pretrained weight to start from
    weights_path = 'C:\\Data\\Tingwei\\Usiigaci-master1.x\\Usiigaci-master\\mask_rcnn_coco.h5'
